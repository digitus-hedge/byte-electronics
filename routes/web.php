...
Route::group(['prefix' => 'brands', 'as' => 'brands.'], function () {
    ...
    //New 1
    Route::get('/details/{slug}', function ($slug) {return redirect("/brands/{$slug}");});
    Route::get('/{slug}/products', [FrontendBrandController::class, 'brandProducts'])->name('brand.products');
