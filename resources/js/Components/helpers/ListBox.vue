...
<template>
    <div class="card shadow-sm">
        ...
        <div class="card-body p-1"
            :style="{ maxHeight: isExpanded ? 'none' : '200px', overflowY: isExpanded ? 'auto' : 'hidden' }">
            <ul class="list-unstyled text-white">
                ...
                <!-- Category list -->
                <li v-for="(category, index) in categories" :key="index" class="border-bottom p-2 position-relative"
        ...
        <template v-if="isBlog">
            ...
            <div class="card-footer p-0 text-center" style="background: #373737;">
                <button
                    :style="{ color: 'white', fontSize: '14px', padding: '5px', background: 'none', border: 'none', cursor: 'pointer' }"
