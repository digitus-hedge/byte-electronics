...
// Debug props
console.log('AttributeFilter.vue props:', {
    filters: props.filters,
    productPageFilter: props.productPageFilter,
    mountingStyleData: props.productPageFilter.find(f => f.head === 'Mounting Style'),
    packageCaseData: props.productPageFilter.find(f => f.head === 'Package / Case'),
});

const emit = defineEmits(['update:filters']);

// Initialize selectedFilters (applied filters) with only attribute filters
...
const getDistinctOptions = (options) => {
    console.log('getDistinctOptions input:', options);
    ...
    console.log('getDistinctOptions output:', filteredOptions);
