            ...
            <div class="col-12">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.banners.create') }}">Create Banner</a></li>
                    </ol>
                </div>
                <div class="card">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateImageLabels(selectedType) {
                    if (imageSizes[selectedType]) {
                        ...
                        // Apply validation without clearing existing images
                                ...
                                .then(data => {
                                    if (data.success) {
                                        Swal.fire({
                                            icon: 'success',
                                            title: 'Success!',
                                            text: data.message || 'Banner created successfully!',
                                    ...
                                    if (error.errors) {
                                        ...
                                        for (let field in error.errors) {
                                            error.errors[field].forEach(message => {
                                                errorMessages += `<p><strong>${field.replace(/_/g, ' ')}:</strong> ${message}</p>`;
                                            });
                                        }
                                        Swal.fire({
                                            icon: 'error',
