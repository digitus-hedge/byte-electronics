...
<head>
    ...
    <style>
        ...
        /* Bootstrap 3 Grid System (Simplified for Email) */
        .row {
            margin-left: -15px;
            margin-right: -15px;
        ...
        <div class="rectangle-box">
            <div class="row">
                <div class="col-12 text-center" style="margin-bottom: 15px;">
                    ...
                    <div style="font-size: 16px; font-weight: 700; color: #333;">Order Confirmation</div>
                </div>
            </div>

            <div class="row">
                <div class="col-12 text-center" style="margin-bottom: 15px;">
                    <div style="font-size: 14px; color: #333;">Thank you for your order with Byte Electronics! Your order #{{ $order->id }} has been successfully placed.</div>
                </div>
            </div>

            <div class="row">
                <div class="col-12 text-center">
                    <div style="font-size: 14px; color: #333; background-color: #EAFFF0; padding: 10px; border-radius: 4px; margin-bottom: 15px;">
            ...
            <div class="row">
                <div class="col-12" style="font-weight: bold; margin-bottom: 5px;">
                    If you have any questions, please contact us at <br> info@byte-electronics.com.
                </div>
            </div>
