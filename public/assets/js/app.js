!(function () {
                    ...
                    ? null !== (t = document.querySelector("#" + e)) &&
                      ...
                      1 ==
                          document.getElementById("layout-direction-ltr")
                              .checked && "layout-direction-ltr" === n
                          ? (document
    ...
    (window.onload = function () {
        ...
        (function () {
            ...
            for (
                var e = document.getElementsByClassName("vertical-menu-btn"),
                    n = 0;
                n < e.length;
                n++
            )
                    ...
                    e.href == l &&
                        ...
                        (t = e.parentElement) &&
                            ...
                            (n = t.parentElement) &&
                                ...
                                n.classList.contains("mm-collapsing") &&
        ...
        (n = document.getElementsByTagName("body")[0]).hasAttribute(
            "data-layout"
        ...
        (function () {
            var e, t;
            document.getElementById("horimenu-btn") &&
                (document
                    .getElementById("horimenu-btn")
                    .addEventListener("click", function (e) {
            ...
            n.addEventListener("click", function () {
                ...
                window.addEventListener("scroll", function () {
                    (100 < document.documentElement.scrollTop ||
                        ...
                        a &&
                        (20 < window.pageYOffset ? s.hide() : s.show(),
